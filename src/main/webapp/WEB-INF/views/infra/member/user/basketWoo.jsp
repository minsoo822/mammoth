				                		...
				                		<td>
				                			<span class="">
				                				<span class="ec-base-qty">
				                					<input id="amount${bskList.bskSeq}" name="bskAmounts" size="2" value="${bskList.bskAmount }" type="text" style="width: 28px;">
			...
			.then((willDelete) => {
			  if (willDelete) {
			    ...
			    .then(function() {
			    		...
			    		const checkboxTotalPrice = checkboxSeqArray.reduce(function add(sum, currValue) {
		    				return sum + currValue;
		    			});
			    		
			    		alert("장바구니 상품 전체 값 : " + $("#lastPrice").val());
			    		alert("선택된 상품 전체 값 : " + checkboxTotalPrice);
