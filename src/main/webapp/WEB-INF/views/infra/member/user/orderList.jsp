...
<body>
	...
	<%@include file="/resources/include/header.jsp"%>
    	...
    	<div class="xans-element- xans-myshop xans-myshop-orderhistorytab ec-base-tab ">
    		<ul class="menu">
    			<li class="tab_class selected">
    				<a href="#">주문내역조회 (<span id="">0</span>)</a>
    			</li>
    			<li class="tab_class_cs">
    				<a href="#">취소/반품/교환 내역 (<span id="">0</span>)</a>
    			</li>
    		</ul>
    	</div>
    			...
    			<fieldset class="ec-base-box">
    				...
    				<div class="stateSelect ">
			            <select id="order_status" name="order_status" class="fSelect">
							...
							<option value="">배송시작(취소/교환불가)</option>
					...
					<span class="period">
			            <a href="#none" class="btnNormal" days="00"><img src="/resources/images/btn_date1.gif" alt="오늘"></a>
			            <a href="#none" class="btnNormal" days="07"><img src="/resources/images/btn_date2.gif" alt="1주일"></a>
			            <a href="#none" class="btnNormal" days="30"><img src="/resources/images/btn_date3.gif" alt="1개월"></a>
			            <a href="#none" class="btnNormal" days="90"><img src="/resources/images/btn_date4.gif" alt="3개월"></a>
			            <a href="#none" class="btnNormal" days="180"><img src="/resources/images/btn_date5.gif" alt="6개월"></a>
			        </span>
			    ...
			    <tbody class="center ">
			    	<tr class="xans-record-">
                		...
                		<td class="product left top">
		                    <a href="#"><strong>포맨트 올인원 퍼퓸 샤워</strong></a>
						...
						<td class="state">
		                    ...
		                    <!-- <p class="txtEm">상품준비중</p> -->
		                </td>
		                <td>
		                    <p class="">
		                    	<a href="#none" class="line" onclick="" style="font-weight: 700;">[상세정보]</a>
	                    	</p>
		                </td>
			    	</tr>
			    </tbody>
    	...
    	<div class="xans-element- xans-myshop xans-myshop-orderhistorypaging ec-base-paginate">
    		<!-- <a href="?page=1&history_start_date=2022-09-28&history_end_date=2022-12-27&past_year=2021" class="first"><img src="//img.echosting.cafe24.com/skin/base/common/btn_page_first.gif" alt="첫 페이지" /></a> -->
    		<a href="#">
    			<img src="/resources/images/btn_page_prev.gif" alt="이전 페이지">
    		</a>
    		<ol>
            ...
            <a href="#">
            	<img src="/resources/images/btn_page_next.gif" alt="다음 페이지">
           	</a>
    	</div>
    	<!-- 페이징 e -->
